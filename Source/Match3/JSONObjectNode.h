...
class MATCH3_API JSONObjectNode : public JSONNode
{
public:
	...
	template<>
	JSONNode::Ptr GetValue<JSONNode::Ptr>(std::string key);
...
template<>
void JSONObjectNode::AddValue(std::string key, JSONObjectNode::Ptr value)
{
	_table[key] = value;
}
